...
/*								*/
extern status	insert_list(pid32 pid, qid16 q, int32 key);
...
/*declare by Neehar in create_user_proc.c*/
...
extern void set_tickets(pid32 id, uint32 tickets);
...
extern void enqueue_list(pid32 pid, qid16	q, uint32 tickets);
